...
\begin{document}
  \hspace*{-\marginparsep minus \marginparwidth}%
   ...
   [.2\baselineskip]%
   GHC 8003, Carnegie Mellon University, 5000 Forbes Ave, 
    ...
    \hspace{0.15in}
    \textit{E-mail:} \href{mailto:bparia@cs.cmu.edu}{bparia@cs.cmu.edu}
       \\[-.55\baselineskip]%
           \rule{\columnwidth}{1pt}
   \end{minipage}
...
\textbf{Carnegie Mellon University}, Pittsburgh, PA \hfill Sep 2017 - Jul 2022 (tentative)\\*
...
% \ifthenelse{\boolean{iscustom}}{
\section{Experience}
Summer Research Intern \hfill Google Research. Mountain View, CA, 2020\\*
\textbf{Hierarchical Time-Series Forecasting} \textit{with} Abhimanyu Das, Amr Ahmed \\*
\textit{Proposed methods for forecasting of time series arranged in an hierarchy.}
\\ \halfblankline

Summer Research Intern \hfill Snap Research. Los Angeles, CA, 2018\\*
\textbf{Sparse Representations for Fast Retrieval} \textit{with} Ian En-Hsu Yen, Ning Xu \\*
\textit{Proposed an approach to sparsify image embeddings in order
to speed up retrieval using sparse matrix multiplication operations.}
\\ \halfblankline
...
\textit{Awarded to the highest ranking student of the graduating class}
\\ \halfblankline
  
Viterbi-India Scholar \awardedby{2015}\\*
\textit{Funded summer internship at Viterbi School of Engineering, USC}
\\ \halfblankline
...
\textit{for being among the top 30 candidates in India}\\*
\textit{Attended the team selection camp for the International Physics Olympiad (IPhO)}
\\ \halfblankline

Indian National Mathematical Olympiad (INMO) Awardee \awardedby{2010 - 2012}\\*
\textit{for being among the top 30 candidates in India}\\*
\textit{Attended the team selection camp for the International Mathematics Olympiad (IMO)}
\\ \halfblankline
  
Kishore Vaigyanik Protsahan Yojana (KVPY) Scholar 
\hfill \textit{DST\ \footnote{Department of Science and Technology}, Govt. of India, 2011}\\*
\textit{for exceptional aptitude in basic sciences, 7th rank in India}
\\ \halfblankline
  
Australian Mathematics Competition (AMC) Gold Medallist \hfill \textit{AMT\ \footnote{Australian Mathematics Trust}, 2009}\\*
\textit{One of 23 medallists in the world}
\\ \halfblankline
\secspace
...
\emph{Libraries:} Tensorflow, PyTorch, numpy, sklearn
\secspace
