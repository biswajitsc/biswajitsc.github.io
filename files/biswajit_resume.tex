...
\textit{Proposed a scalable method for forecasting of time series arranged in an hierarchy
...
\textit{Proposed an approach to sparsify image embeddings resulting in
